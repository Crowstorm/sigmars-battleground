        ...
        if (this.props.dice.isRolled) {
            ...
            return (
                ...
                {/* <Image source={Roll} style={styles.smallRollButton} /> */}
                    <Text style={styles.diceResultText}>Number of 6s: <Text style={styles.diceResultTextGenerated}>  {_six}  </Text> <Image source={Roll} style={styles.smallRollButton} />  </Text>
                    <Text style={styles.diceResultText}>Number of 5s and above:<Text style={styles.diceResultTextGenerated}>  {_five}  </Text> <Image source={Roll} style={styles.smallRollButton} /> </Text>
