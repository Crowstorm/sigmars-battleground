        ...
        if (this.props.dice.isRolled) {
            return (
                <View style={styles.diceResult}>
                    ...
                    <Text style={styles.diceResultText}>Number of 4s and above:<Text style={styles.diceResultTextGenerated}>  {six + five + four}  </Text><Image source={Roll} style={styles.smallRollButton} /></Text>
                    <Text style={styles.diceResultText}>Number of 3s and above:<Text style={styles.diceResultTextGenerated}>  {six + five + four + three}  </Text><Image source={Roll} style={styles.smallRollButton} /></Text>
                    <Text style={styles.diceResultText}>Number of 2s and above:<Text style={styles.diceResultTextGenerated}>  {six + five + four + three + two}  </Text><Image source={Roll} style={styles.smallRollButton} /></Text>
                    <Text style={styles.diceResultText}>Number of 1s:<Text style={styles.diceResultTextGenerated}>  {one}  </Text><Image source={Roll} style={styles.smallRollButton} /></Text>
                </View>
            )
        }
    }
